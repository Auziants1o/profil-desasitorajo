...
<div class="page-hero">
    <div class="container">
        ...
        <div class="breadcrumb"><a href="{{ route('beranda') }}">Beranda</a><i class="fas fa-chevron-right"></i><span>Kebudayaan</span></div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="card" style="overflow:hidden; margin-bottom: 48px;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0; min-height: 400px;">
            ...
            <div style="position: relative; overflow: hidden;">
                <img src="{{ asset('images/kebudayaan/Pacu-Jalur-Kuansing-Event-Kebudayaan.jpg') }}"
                     alt="Pacu Jalur"
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;">
        ...
        <div class="card" style="padding: 28px; text-align: center;">
            <div style="width:56px;height:56px;border-radius:16px;background:{{ $n[1] }};color:{{ $n[2] }};display:flex;align-items:center;justify-content:center;font-size:24px;margin: 0 auto 16px;">
                <i class="{{ $n[0] }}"></i>
            </div>
            <h4 style="font-size:15px;font-weight:700;margin-bottom:10px;">{{ $n[3] }}</h4>
            <p style="font-size:13px;color:var(--text-muted);line-height:1.7;">{{ $n[4] }}</p>
        </div>
        @endforeach
    </div>
</div>
