...
<section class="hero">
    <video autoplay loop muted playsinline class="hero-video" id="bgVideo">
        <source src="<?php echo e(asset('images/beranda/lv_7620500222858349831_20260721151031.mp4')); ?>" type="video/mp4">
    </video>
    ...
    <div class="hero-content">
        ...
        <div class="hero-btns" style="justify-content: center;">
            ...
            <a href="<?php echo e(route('profil')); ?>" class="btn btn-accent"><i class="fas fa-landmark"></i> Profil Desa</a>
            <a href="<?php echo e(route('kontak')); ?>" class="btn btn-glass"><i class="fas fa-envelope"></i> Hubungi Kami</a>
        </div>
    </div>
</section>
...
<section class="section" style="background:var(--bg-light); padding-top: 20px;">
    <div class="container">
        ...
        <div class="quick-menu">
            <a href="<?php echo e(route('profil')); ?>" class="qm-item">
            ...
            <a href="<?php echo e(route('perangkat')); ?>" class="qm-item">
            ...
            <a href="<?php echo e(route('data-penduduk')); ?>" class="qm-item">
            ...
            <a href="<?php echo e(route('kebudayaan')); ?>" class="qm-item">
            ...
            <a href="<?php echo e(route('kontak')); ?>" class="qm-item">
...
<section class="section" style="background:var(--bg-light);">
    <div class="container">
        ...
        <div class="galeri-grid">
            <?php $__currentLoopData = $galeriTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($g->file): ?>
            <div class="galeri-item">
                <img src="<?php echo e(asset($g->file)); ?>" alt="<?php echo e($g->judul); ?>"
                     onerror="this.closest('.galeri-item').style.display='none'">
                <div class="overlay"><span><?php echo e($g->judul); ?></span></div>
            </div>
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div style="text-align:center;margin-top:32px">
            <a href="<?php echo e(route('galeri-foto')); ?>" class="btn btn-primary"><i class="fas fa-images"></i> Lihat Galeri Lengkap</a>
        </div>
    </div>
</section>
<?php endif; ?>
    ...
    <div class="container">
        <div class="cta-banner">
            ...
            <div style="display:flex;gap:12px;flex-shrink:0;flex-wrap:wrap">
                <a href="<?php echo e(route('kontak')); ?>" class="btn btn-accent"><i class="fas fa-envelope"></i> Kirim Pesan</a>
                <a href="<?php echo e(route('peta')); ?>" class="btn btn-glass"><i class="fas fa-map"></i> Lihat Peta</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\profil-desasitorajo\resources\views/beranda.blade.php ENDPATH**/ ?>