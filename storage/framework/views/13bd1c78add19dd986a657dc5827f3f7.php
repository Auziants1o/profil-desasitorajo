...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Desa Sitorajo'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Informasi profil desa, pemerintahan, dan layanan masyarakat Desa Sitorajo.'); ?>">
...
<nav class="navbar" x-data="{ mobileOpen: false }">
    <div class="navbar-inner">
        ...
        <ul class="navbar-menu">
            <li><a href="<?php echo e(route('beranda')); ?>" class="<?php echo e(request()->routeIs('beranda') ? 'active' : ''); ?>">Beranda</a></li>
            ...
            <li x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                ...
                <div class="nav-dropdown" x-show="open" x-transition style="display:none;">
                    <a href="<?php echo e(route('profil')); ?>"><i class="fas fa-landmark"></i>Profil Desa</a>
                    <a href="<?php echo e(route('sejarah')); ?>"><i class="fas fa-scroll"></i>Sejarah Desa</a>
                    <a href="<?php echo e(route('kebudayaan')); ?>"><i class="fas fa-masks-theater"></i>Kebudayaan</a>
                </div>
            </li>
            ...
            <li x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                ...
                <div class="nav-dropdown" x-show="open" x-transition style="display:none;">
                    <a href="<?php echo e(route('struktur')); ?>"><i class="fas fa-sitemap"></i>Struktur Organisasi</a>
                    <a href="<?php echo e(route('perangkat')); ?>"><i class="fas fa-users"></i>Perangkat Desa</a>
                </div>
            </li>
            ...
            <li x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                ...
                <div class="nav-dropdown" x-show="open" x-transition style="display:none;">
                    <a href="<?php echo e(route('data-penduduk')); ?>"><i class="fas fa-chart-pie"></i>Data Penduduk</a>
                    <a href="<?php echo e(route('potensi')); ?>"><i class="fas fa-mountain-sun"></i>Potensi Desa</a>
                </div>
            </li>
            ...
            <li x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                ...
                <div class="nav-dropdown" x-show="open" x-transition style="display:none;">
                    <a href="<?php echo e(route('galeri-foto')); ?>"><i class="fas fa-images"></i>Galeri Foto</a>
                </div>
            </li>
            ...
            <li x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                ...
                <div class="nav-dropdown" x-show="open" x-transition style="display:none;">
                    <a href="<?php echo e(route('kontak')); ?>"><i class="fas fa-envelope"></i>Kontak</a>
                    <a href="<?php echo e(route('peta')); ?>"><i class="fas fa-map-location-dot"></i>Peta Lokasi</a>
                </div>
            </li>
        </ul>
    ...
    <div class="mobile-menu" :class="{ 'open': mobileOpen }">
        <a href="<?php echo e(route('beranda')); ?>"><i class="fas fa-home"></i> Beranda</a>
        <div class="m-group-title">Profil Desa</div>
        <a href="<?php echo e(route('profil')); ?>">Profil Desa</a>
        <a href="<?php echo e(route('sejarah')); ?>">Sejarah Desa</a>
        <a href="<?php echo e(route('kebudayaan')); ?>">Kebudayaan</a>
        <div class="m-group-title">Pemerintahan</div>
        <a href="<?php echo e(route('struktur')); ?>">Struktur Organisasi</a>
        <a href="<?php echo e(route('perangkat')); ?>">Perangkat Desa</a>
        <div class="m-group-title">Kependudukan</div>
        <a href="<?php echo e(route('data-penduduk')); ?>">Data Penduduk</a>
        <a href="<?php echo e(route('potensi')); ?>">Potensi Desa</a>
        <div class="m-group-title">Galeri & Informasi</div>
        <a href="<?php echo e(route('galeri-foto')); ?>">Galeri Foto</a>
        <a href="<?php echo e(route('kontak')); ?>">Kontak</a>
        <a href="<?php echo e(route('peta')); ?>">Peta Lokasi</a>
    </div>
</nav>
    ...
    <div class="footer-inner">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                <h4>Profil Desa</h4>
                <ul>
                    <li><a href="<?php echo e(route('profil')); ?>"><i class="fas fa-chevron-right"></i>Profil Desa</a></li>
                    <li><a href="<?php echo e(route('sejarah')); ?>"><i class="fas fa-chevron-right"></i>Sejarah Desa</a></li>
                    <li><a href="<?php echo e(route('kebudayaan')); ?>"><i class="fas fa-chevron-right"></i>Kebudayaan</a></li>
                    <li><a href="<?php echo e(route('struktur')); ?>"><i class="fas fa-chevron-right"></i>Struktur Org.</a></li>
                    <li><a href="<?php echo e(route('perangkat')); ?>"><i class="fas fa-chevron-right"></i>Perangkat Desa</a></li>
                </ul>
            </div>
            ...
            <div class="footer-col">
                <h4>Layanan</h4>
                <ul>
                    <li><a href="<?php echo e(route('data-penduduk')); ?>"><i class="fas fa-chevron-right"></i>Data Penduduk</a></li>
                    <li><a href="<?php echo e(route('potensi')); ?>"><i class="fas fa-chevron-right"></i>Potensi Desa</a></li>
                    <li><a href="<?php echo e(route('galeri-foto')); ?>"><i class="fas fa-chevron-right"></i>Galeri Foto</a></li>
                    <li><a href="<?php echo e(route('peta')); ?>"><i class="fas fa-chevron-right"></i>Peta Lokasi</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            <span>© <?php echo e(date('Y')); ?> Desa Sitorajo. Hak Cipta Dilindungi.</span>
        </div>
    </div>
</footer>
...
<?php /**PATH C:\laragon\www\profil-desasitorajo\resources\views/layouts/app.blade.php ENDPATH**/ ?>