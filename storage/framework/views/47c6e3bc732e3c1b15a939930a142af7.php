<?php $__env->startSection('title','Kontak & Peta'); ?>
<?php $__env->startSection('content'); ?>
<div class="page-hero">
    <div class="container">
        <h1><i class="fas fa-envelope"></i> Kontak Kami</h1>
        <p>Hubungi pemerintahan Desa Sitorajo untuk informasi dan layanan</p>
        <div class="breadcrumb"><a href="<?php echo e(route('beranda')); ?>">Beranda</a><i class="fas fa-chevron-right"></i><span>Kontak</span></div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\profil-desasitorajo\resources\views/kontak.blade.php ENDPATH**/ ?>