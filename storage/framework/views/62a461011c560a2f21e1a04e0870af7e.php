...
<div class="page-hero">
    <div class="container">
        ...
        <div class="breadcrumb"><a href="<?php echo e(route('beranda')); ?>">Beranda</a><i class="fas fa-chevron-right"></i><span>Profil Desa</span></div>
    </div>
</div>
...
<img src="<?php echo e(asset('images/profildesa/maxresdefault%20(1).jpg')); ?>" alt="Desa Sitorajo" style="width:100%;height:220px;object-fit:cover">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\profil-desasitorajo\resources\views/profil.blade.php ENDPATH**/ ?>